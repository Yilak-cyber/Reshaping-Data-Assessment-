...
#.................Question # 1....................
# A collaborator sends you a file containing data for three years 
# of average race finish times.
# age_group,2015,2016,2017
# 20,3:46,3:22,3:50
# 30,3:50,3:43,4:43
# 40,4:39,3:49,4:51
# 50,4:48,4:59,5:01
Names<-c('age_group','2015','2016','2017')
age<-c(20,30,40,50)
CY2015<-c("3:46","3:50","4:39","4:48")
CY2016<-c("3:22","3:43","3:49","4:59")
CY2017<-c("3:50","4:43", "4;51","5:01")
finish_times<-data.frame(age,CY2015,CY2016,CY2017)
finish_times
#rbind(finish_times,CY2018)
# Are these data considered "tidy" in R? Why or why not?
# Answer: No. These data are not considered "tidy" 
         # because the variable "year" is stored in the header.

#.................Question # 2....................

# Below are four versions of the same dataset. 
...
# Your file called "times.csv" has age groups and average race finish times 
# for three years of marathons.
# age_group,2015,2016,2017
# 20,3:46,3:22,3:50
# 30,3:50,3:43,4:43
# 40,4:39,3:49,4:51
...
# use the steps and the out put from Question #1


tidy_data <- finish_times %>%
  gather(year, time, `CY2015`:`CY2017`)
tidy_data
...
# You have a dataset on U.S. contagious diseases, 
# but it is in the following wide format:
head(dat_wide)
...
# You want to transform this into a tidy dataset, 
# with each row representing an observation of the incidence of 
# each specific disease (as shown below):
# head(dat_tidy)
...
# Which of the following commands would achieve this transformation 
# to tidy the data? Pay attention to the column names.
# Answer: dat_tidy <- dat_wide %>%
  gather(key = disease, value = count, HepatitisA:Rubella)

#.................Question # 5....................
  
# You have successfully formatted marathon finish times into a tidy 
  # object called tidy_data. The first few lines are shown below.
  # age_group year   time
  # 20        2015   03:46
  # 30        2015   03:50
  # 40        2015   04:39
...
# Answer:  tidy_data %>% spread(year, time)
...
state<-c("Alabama","Alabama","Alaska","Alaska","Arizona","Arizona")
...
dat<-data.frame(state,abb,region,var,people)
dat   
# You would like to transform it into a dataset 
# where population and total are each their own column (shown below):
# state      abb region population total
# Alabama     AL  South	4779736   135
# Alaska      AK   West 	 710231    19
# Arizona     AZ   West	6392017   232
...
dat_tidy
# Answer:dat_tidy <- dat %>% spread(key = var, value = people)

#.................Question # 7....................

#A collaborator sends you a file containing data for two years of 
# average race finish times, "times.csv":   
...
# You are in the process of tidying some data on heights, 
# hand length, and wingspan for basketball players in the draft. 
...
# bamba_wingspan    94
# Select all of the correct commands below that would turn this data into a "tidy"
# format with columns "height", "hand_length" and "wingspan".
# Answer:  
tidy_data <- stats %>%
